...
LICENSE="GPL-3"
SLOT="0"
IUSE="gstreamer pdfjs test +webengine webkit"
...
RDEPEND="${COMMON_DEPEND}
	...
	dev-python/PyQt5[${PYTHON_USEDEP},declarative,gui,network,printsupport,sql,webengine?,webkit?,widgets]
	dev-python/sip[${PYTHON_USEDEP}]
	>=dev-python/pyyaml-3.12[${PYTHON_USEDEP}]
	gstreamer? ( webkit? ( dev-qt/qtwebkit:5[gstreamer] ) )
